...
<div class="businessCategory view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $businessCategory->status ? __('Yes') : __('No'); ?></td>
        </tr>
    </table>
    <div class="related">
        <h4><?= __('Related User Business Basic Details') ?></h4>
        <?php if (!empty($businessCategory->user_business_basic_details)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($businessCategory->user_business_basic_details as $userBusinessBasicDetails): ?>
            <tr>
